...
def main(cfg, args):
    ...
    best_metric, epoch = evaluator(cfg, args, epoch=cfg.TRAIN.MAX_EPOCH,
...
def evaluator(cfg, args, epoch, model, model_ema, train_loader, valid_loader, criterion, optimizer, lr_scheduler,
