...
T_mult = 2
# Define the run name
run_name = f"Oruns/GPT/balanceCE{datetime.now().strftime('%Y%m%d_%H%M%S')}_{NUM_EPOCHS}epochs_[backbone_lr{backbone_lr},classifier_lr{classifier_lr}, eta_min{eta_min}]"
